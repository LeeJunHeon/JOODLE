...
class _LoginPage extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      /// false면 SingleChildScrollView 스크롤이 안먹힘
  ...
  Widget logo(double height_, double width_) {
    return Image.asset(
      'assets/images/logo/joodle_logo_1.png',
      height: height_,
      width: width_,
    );
  }
  ...
  Widget emailTextField(Size size) {
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(hintText: '휴대폰 번호를 입력하세요', hintStyle: GoogleFonts.inter(
          fontSize: 16.0,
          color: const Color(0xFF151624).withOpacity(0.5),
          ),
          counterText: '',
          fillColor: _phoneController.text.isNotEmpty ? Colors.transparent : const Color.fromRGBO(248, 247, 251, 1),
          filled: true,
          enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(40),
              borderSide: BorderSide(
                color: _phoneController.text.isEmpty ? Colors.transparent : const Color.fromRGBO(44, 185, 176, 1),
              )),
          ...
          prefixIcon: Icon(
            ...
            color: _phoneController.text.isEmpty ? const Color(0xFF151624).withOpacity(0.5) : const Color.fromRGBO(44, 185, 176, 1),
            size: 20,
          ),
          suffix: Container(
            alignment: Alignment.center,
            ...
            // ),
            child: _phoneController.text.isEmpty ? const Center() : const Icon(
              Icons.check,
              color: Color.fromRGBO(44, 185, 176, 1),
              size: 20,
            ),
    ...
    return SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: _passController.text.isNotEmpty
              ? Colors.transparent
          ...
          suffix: Container(
            ...
            width: 24.0,
            height: 24.0,
            child: _passController.text.isEmpty ? const Center() : const Icon(
              Icons.check,
              color: Color.fromRGBO(44, 185, 176, 1),
              size: 20,
            ),
  ...
  Widget signInButton(Size size) {
    return GestureDetector(
      onTap: (){
        _login('+82${_phoneController.text.trim()}', _passController.text.trim());
      },
      child: Container(
        alignment: Alignment.center,
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          width: size.width / 2.8,
          height: size.height / 13,
          child: Image.asset("assets/images/login_button/kakao_login_large_narrow.png"),
          ),
        //facebook button
        // Container(
        //   alignment: Alignment.center,
  ...
  Future<void> _login(String username, String password)  async {
    try {
      ...
      await handleSignInResult(result, username);
      setState(() {
      ...
      //   content: const Center(child: Text("등록되지 않은 번호입니다. 다시 입력 후 시도해주세요")),
